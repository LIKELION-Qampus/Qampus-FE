document.addEventListener('DOMContentLoaded', () => {
    ...
    ellipsisBtn.addEventListener('click', (e) => {
      ...
      if (ellipsisImg) {
        ellipsisImg.src = isHidden 
            ? '../assets/icons/ellipsis-vertical-g.svg' 
            : '../assets/icons/ellipsis-vertical-b.svg';
      }
    });
    ...
    howtolistBtn.addEventListener('click', (e) => {
      ...
      howtolistArrow.src = isHidden ? '../assets/icons/upvector.svg' : '../assets/icons/downvector.svg';
    });
    ...
    document.addEventListener('click', (e) => {
        if (!popupPostBtn.contains(e.target)) {
          ...
          if (ellipsisImg) {
            ellipsisImg.src = '../assets/icons/ellipsis-vertical-b.svg';
          }
        }
        if (!howtolistPopup.contains(e.target)) {
          howtolistPopup.style.display = 'none';
          howtolistArrow.src = '../assets/icons/downvector.svg';
        }
      });
    ...
    categories.forEach((category) => {
      category.addEventListener('click', () => {
        ...
        const navLeft = category.closest('.navigation').getBoundingClientRect().left;
